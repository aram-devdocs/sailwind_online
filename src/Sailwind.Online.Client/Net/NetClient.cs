...
namespace Sailwind.Online.Client.Net
{
    ...
    /// </summary>
    public sealed class NetClient : IServerMessageHandler, IDisposable
    {
        ...
        public NetClient(ManualLogSource log)
        {
            _log = log;
        ...
        {
            _cache.Clear();
            _peer = _manager.Connect(_options.Host, _options.Port, ConnectKey);
            _status = ConnectionStatus.Connecting;
            _log.LogInfo("[Sailwind.Online] Connecting to " + _options.Host + ":" + _options.Port + " ...");
        }
        ...
        internal static string FormatTimeOfDay(float fractionOfDay)
        {
