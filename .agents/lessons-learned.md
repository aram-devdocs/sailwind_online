...
2026-07-21: The API surface hash for game build 23880593 (mvid fa39e939-d8e9-4d04-9648-4e10452ea8a3) is d6fb6a7e over 19 verified members (11 types + 8 members); regenerate with `make codegen` after any game update and expect the hash to change.
